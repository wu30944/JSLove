...
<head>
    ...
    <meta http-equiv="x-pjax-version" content="<?php echo e(loadEdition('/css/app.css')); ?>">
    <title><?php echo e(config('app.title')); ?> - <?php echo $__env->yieldContent('title', config('app.name', 'Laravel')); ?></title>
...
<script src="<?php echo e(loadEdition('/js/plugins/layer/src/layer.js')); ?>"></script>
