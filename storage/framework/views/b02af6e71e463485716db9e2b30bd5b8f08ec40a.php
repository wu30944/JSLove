            ...
            <li class="nav-header text-center">
                <div class="dropdown profile-element">
                    ...
                    <ul class="dropdown-menu animated fadeInRight m-t-xs">
                        <li><a class="J_menuItem" href="form_avatar.html"><?php echo app('translator')->getFromJson('default.change_avatar'); ?></a></li>
                        <li><a class="J_menuItem" href="form_avatar.html"><?php echo app('translator')->getFromJson('default.change_password'); ?></a></li>
                        <li class="divider"></li>
                        <li><a href="<?php echo e(route('admin.logout')); ?>"><?php echo app('translator')->getFromJson('default.safe_exit'); ?></a></li>
                    </ul>
                </div>
                        ...
                        <?php if(isset($rule['children'])): ?>
                            <ul class="nav nav-second-level collapse">
                                <?php $__currentLoopData = $rule['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a class="J_menuItem" href="" data-index="<?php echo e($item['id']); ?>"><?php echo e($item['name']); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                <?php endif; ?>
                <li>
                <?php else: ?>
                    <li>
                        ...
                        <?php if(isset($rule['children'])): ?>
                            <ul class="nav nav-second-level collapse">
                                <?php $__currentLoopData = $rule['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($item['route']=="pos.index"): ?>
                                        <li><a class="" href="<?php echo e(route($item['route'])); ?>" data-index="index_v1.html"><?php echo e($item['name']); ?></a></li>
                                    <?php else: ?>
